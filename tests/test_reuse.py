...
class TestReuse(TestCase):
    ...
    def test_blueprint_reuse(self):
        ...
        counter = self.machine_cls(
            states=states, transitions=transitions, before_state_change="check", after_state_change="clear", initial="1"
        )
        ...
        walker = self.machine_cls(
            states=new_states, transitions=new_transitions, before_state_change="watch", after_state_change="look_back", initial="A"
        )
    ...
    def test_blueprint_remap(self):
        ...
        new_states = [
            ...
            {
                "name": "C",
                "children": [counter, {"name": "X", "children": ["will", "be", "filtered", "out"]}],
    ...
    def test_example_reuse(self):
        ...
        states_remap = ["waiting", "collecting", {"name": "counting", "children": counter, "remap": {"done": "waiting"}}]  # type: List[Union[str, Dict[str, Union[str, HierarchicalMachine, Dict]]]]

        transitions = [["collect", "*", "collecting"], ["wait", "*", "waiting"], ["count", "*", "counting%s1" % State.separator]]  # type: Sequence[TransitionConfig]
        ...
        self.assertEqual(collector.state, f"counting{State.separator}done")
    ...
    def test_reuse_add_state(self):
        ...
        counter = self.machine_cls(states=count_states, transitions=count_trans, initial="1")
        counter.increase()  # love my counter
        states_remap = ["waiting", "collecting"]  # type: List[Union[str, Dict[str, Union[str, HierarchicalMachine, Dict]]]]
    ...
    def test_reuse_model_decoration(self):
        ...
        # reuse counter instance with remap
        collector = self.machine_cls(states=states_remap + [additional_state], transitions=transitions, initial="waiting")
    ...
    def test_reuse_self_reference(self):
        ...
        class Nested(self.machine_cls):  # type: ignore
            def __init__(self, parent):
                ...
                super().__init__(states=states, transitions=transitions, initial="1")
        ...
        class Top(self.machine_cls):  # type: ignore
            ...
            def __init__(self):
                ...
                transitions = [
                    dict(trigger="print_top", source="*", dest="=", after=self.print_msg),
                    dict(trigger="to_nested", source="*", dest=f"B{separator}1"),
                ]
        ...
        self.assertIs(top_machine.nested.get_state("2").on_enter, top_machine.get_state(f"B{separator}2").on_enter)

    def test_reuse_machine_config(self):
        simple_config = {"name": "Child", "states": ["1", "2"], "tfsm": [["go", "1", "2"]], "initial": "1"}  # type: Dict[str, Any]
    ...
    def test_reuse_remap(self):
        ...
        class GenericMachine(self.machine_cls):  # type: ignore
            def __init__(self, states, transitions, model=None):
                ...
                super().__init__(states=states, transitions=transitions, model=model, send_event=True, queued=True, auto_transitions=False)
        ...
        transitions = [
            {
                ...
                "source": "A",
                "dest": "B",
                "conditions": m.check_self,
                "prepare": m.check_self,
                "before": m.check_self,
                "after": m.check_self,
            }
        ]  # type: Sequence[TransitionConfig]
